...
```{r congress-raw-data-function, eval = FALSE}
...
```{r congress-raw-data-all, eval = FALSE}
...
```{r type2-raw-data-pusan, eval = FALSE}
...
```{r type3-get-raw-data, eval = FALSE}
...
```{r type3-identify-number-of-precinct, eval = FALSE}
...
```{r type3-identify-number-of-precinct-gannam, eval = FALSE}
...
```{r type3-identify-number-of-precinct-one, eval = FALSE}
...
```{r post-processing-gu, eval = FALSE}
seoul_precint_list <- read_rds("data/seoul_precint_list.rds")
...
```{r make-clean-function, eval = FALSE}
